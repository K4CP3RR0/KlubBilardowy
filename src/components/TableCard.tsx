...
const TableCard = ({ id, type, status, image }) => (
  ...
  <div className="bg-[#1a1a1b] border-2 montserrat-light border-green-500 rounded-xl overflow-hidden cursor-pointer hover:scale-95 transition-transform w-full shadow-lg">
