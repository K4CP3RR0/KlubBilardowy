...
function Logowanie() {
    ...
    return (
        ...
        <form onSubmit={handleLogin} className="md:col-span-2 md:col-start-2 rounded-lg p-10 m-2 content-center md:w-1/2  montserrat-light bg-[#1a1a1b] shadow-md shadow-black">
            ...
            <div className="mt-6 text-center p-2">
                <button className="rounded-md bg-[#0056b3] px-5 m-2 py-2.5 text-sm leading-5 text-white hover:bg-[#0056d3]">Zaloguj się</button>
            </div>
        </form>
        <div className="mt-6 mb-6 text-center p-2 col-span3 col-start-2">
            <p className="text-white montserrat-extrabold">Nie masz konta? Zarejestruj się klikając przycisk poniżej.</p><br/>
            <a href="/rejestracja" className="rounded-md bg-[#0056f3] px-5 m-2 py-2.5 text-sm leading-5 text-white hover:bg-[#1a1a1b] drop-shadow-xl ">Zarejestruj się</a>
        </div>
        </div>
            <Footer/>
        </div>
